...
export default function Ethan_Davis() {
  return (
    <div>
      <div className="mx-48">
        <div className="text-[64px] font-bold text-center mb-16">Ethan Davis</div>
        <div className="flex mb-[128px]">
          <img src={Model1} className="mr-16 h-[640px] rounded-2xl" />
        ...
        <a className="text-[32px] font-medium text-center mb-16 flex justify-center bg-slate-200 hover:shadow-xl transition-all duration-200 cursor-pointer rounded-xl py-4">SAR 150 - Reservation</a>
      </div>
    </div>
  );
}
